...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_retrieve_ingredients(self):
        ...
        Ingredient.objects.create(user=self.user, name='Pista')
    ...
    def test_ingredients_limited_to_user(self):
        ...
        Ingredient.objects.create(user=other_user, name='Apple')
    ...
    def test_delete_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Wheat')
